...
public class BackgroundColorDialog extends AppCompatDialogFragment {

    private RadioGroup radioGroup;
    private RadioButton radioButton;
    int chosenColor;
    EditText colorEditText;
    private BackgroundColorDialog.BackgroundColorDialogListner backgroundColorDialogListner;
                ...
                .setPositiveButton("Done", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(view.findViewById(radioGroup.getCheckedRadioButtonId())!=null) {
                            ...
                            backgroundColorDialogListner.changeBackgroundColor(chosenColor);
                        }
                        else if(!colorEditText.getText().toString().trim().isEmpty())
                        {
                            ...
                            {
                                backgroundColorDialogListner.changeBackgroundColor(Color.parseColor(colourSeq));
                            }
                        }
                    }
                });
    ...
    public void onAttach(@NonNull Context context) {
        ...
        try {
            backgroundColorDialogListner = (BackgroundColorDialog.BackgroundColorDialogListner) context;
        } catch (Exception e) {
            e.printStackTrace();
        }
    }

    public interface BackgroundColorDialogListner{
        void changeBackgroundColor(int chosenColor);
    }
